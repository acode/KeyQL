...
KeyQL is a package and language specification for querying datasets using key-value pairs.
The provided Node.js package can be used to filter large JSON datasets from any
