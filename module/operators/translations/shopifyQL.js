...
module.exports = {
  ...
  'icontains': (a, b) => { throw new Error('Operator `icontains` not supported') },
  'contains': (a, b) => { throw new Error('Operator `contains` not supported') },
  'startswith': (a, b) => { throw new Error('Operator `startswith` not supported') },
  'istartswith': (a, b) => { throw new Error('Operator `istartswith` not supported') },
  'wordstartswith': () => { throw new Error('Operator `wordstartswith` not supported') },
  'iwordstartswith': (a, b) => `${a}:\\"${escapeSpecialChars(b)}\\"*`,
  'endswith': (a, b) => { throw new Error('Operator `endswith` not supported') },
  'iendswith': (a, b) => { throw new Error('Operator `iendswith` not supported') },
  'wordendswith': (a, b) => { throw new Error('Operator `wordendswith` not supported') },
  'iwordendswith': (a, b) => { throw new Error('Operator `iwordendswith` not supported')},
  'like': () => { throw new Error('Operator `like` not supported') },
  'ilike': () => { throw new Error('Operator `ilike` not supported') },
  'is_null': (a, b) => `-${a}:*`,
  'is_true': (a, b) => `${a}:true`,
